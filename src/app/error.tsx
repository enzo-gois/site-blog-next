    ...
    <div className="min-h-[400px] flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center">
        <div className="relative inline-block mb-6">
          ...
          <div
            className="absolute h-1 w-16 bg-red-500 -rotate-12 top-1/2 left-1/2 transform
        ...
        {error?.message && (
          <p
            className="text-gray-200 mb-2 px-4 text-body-sm overflow-hidden
        text-ellipses max-h-24"
          >
            {error?.message}
          </p>
        )}
