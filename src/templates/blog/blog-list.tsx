    ...
    <div className="flex flex-col py-24 flex-grow h-full">
      ...
      {!hasPosts && (
        <div className="container px-8">
          <div className="flex flex-col items-center jusitfy-center gap-8">
            <Inbox className="h-12 w-12 text-cyan-100 border-dashed border-2 border-gray-300 p-8 md: p-12 rounded-lg" />
